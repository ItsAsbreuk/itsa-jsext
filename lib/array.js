...
var TYPES = {
    ...
    FUNCTION = "function",
    isObject, objSameValue, cloneObj, deepCloneObj, valuesAreTheSame;
...
deepCloneObj = function (obj, descriptors) {
    ...
    while (++i < l) {
        ...
        if (descriptors) {
            ...
            if ((isObject(value) || Array.isArray(value)) && ((typeof propDescriptor.get)!==FUNCTION) && ((typeof propDescriptor.set)!==FUNCTION) ) {
            ...
            m[key] = (isObject(value) || Array.isArray(value)) ? cloneObj(value, descriptors) : value;
        }
    }
    return m;
};
...
cloneObj = function(obj, descriptors, target) {
    ...
    if (obj instanceof Array) {
        ...
        for (i=0; i<len; i++) {
            value = obj[i];
            copy[i] = (isObject(value) || Array.isArray(value)) ? cloneObj(value, descriptors) : value;
        }
        return copy;
    }
